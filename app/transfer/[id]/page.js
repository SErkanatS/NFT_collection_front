...
export default function Home({ params }) {
  ...
  return (
    <main className="flex min-h-[80vh] flex-col items-center justify-between pt-24">
      <div className="flex relative flex-col h-48 items-center gap-4 justify-start lg:justify-center lg:static lg:h-auto w-auto bg-none">

        <div key={1} className="w-full max-w-sm z-20 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-600 dark:border-gray-700">
          <img className="p-8 rounded-xl" src={nftData.image} alt='IPFS Image' />
        ...
        <div className=' flex gap-2 w-full' >
          ...
          <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" type="button" className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" onClick={() => {
            setShow(true)
          }}>Burn</button>
      ...
      {show &&
        ...
        <div className=" absolute bg-white rounded-lg shadow dark:bg-gray-700 z-40">
          <button type="button" className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal" onClick={() => {
            setShow(false)
          }}>
          ...
          <div className="p-6 text-center">
            ...
            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to burn this NFT?</h3>
